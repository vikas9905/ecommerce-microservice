...
public class ProductControllerImpl implements ProductController {
    ...
    public ResponseEntity<ApiResponse> getProduct(@PathVariable String id) {
        return new ResponseEntity<>(new ApiResponse(productService.getProductById(id), HttpStatus.OK.value(),"Record Fetched Success",null),HttpStatus.OK);
    }

    @Override
    public ResponseEntity<ApiResponse> getProducts() {
        return new ResponseEntity<>(new ApiResponse(productService.getProducts(), HttpStatus.OK.value(),"Record Fetched Success",null),HttpStatus.OK);
    }
}
